...
namespace SQLDataProducer.Tests.ValueGenerators
{
    ...
    public class MinutesDateTimeGeneratorTest
    {
        ...
        public void ShouldTestStep()
        {
            ...
            Assert.That(firstValue + TimeSpan.FromMinutes(1), Is.EqualTo(secondValue));
        }
        ...
        {
            var gen = new MinutesDateTimeGenerator(new ColumnDataTypeDefinition("DateTime2(2)", false));
            var gen2 = new MinutesDateTimeGenerator(new ColumnDataTypeDefinition("DateTime2(2)", false));
