...
namespace SQLDataProducer.Tests.ValueGenerators
{
    ...
    public class DaysSeriesDateTimeGeneratorTest
    {
        ...
        public void ShouldTestStep()
        {
            ...
            Assert.That(firstValue + TimeSpan.FromDays(1), Is.EqualTo(secondValue));
        }
        ...
        {
            var gen = new DaysSeriesDateTimeGenerator(new ColumnDataTypeDefinition("DateTime2(2)", false));
            var gen2 = new DaysSeriesDateTimeGenerator(new ColumnDataTypeDefinition("DateTime2(2)", false));
